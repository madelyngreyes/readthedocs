...
Programmatic use of BigQuery is demonstrated through this workshop material doing `Analysis with R and BigQuery <../workshop/Workshop_R_tut_v2.html>`_ as well as the `Query of the Month Club <../QueryOfTheMonthClub.html>`_ that demonstrates new and interesting queries that show the `Big Data Analytic Power' of BigQuery using ISB-CGC BigQuery data.
